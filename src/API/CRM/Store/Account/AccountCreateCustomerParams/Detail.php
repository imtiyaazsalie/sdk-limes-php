...
use SDKLimes\API\CRM\Store\Account\AccountCreateCustomerParams\Detail\BillMedia;
use SDKLimes\API\CRM\Store\Account\AccountCreateCustomerParams\Detail\Identification;
use SDKLimes\Core\Attributes\Optional;
use SDKLimes\Core\Concerns\SdkModel;
use SDKLimes\Core\Contracts\BaseModel;

/**
 * @phpstan-import-type BillMediaShape from \SDKLimes\API\CRM\Store\Account\AccountCreateCustomerParams\Detail\BillMedia
 * @phpstan-import-type IdentificationShape from \SDKLimes\API\CRM\Store\Account\AccountCreateCustomerParams\Detail\Identification
 *

...
use SDKLimes\API\CRM\Store\Account\Account\CollectionPlan;
use SDKLimes\API\CRM\Store\Account\Account\Contact;
use SDKLimes\API\CRM\Store\Account\Account\Detail;
use SDKLimes\API\CRM\Store\Account\Account\Phone;
use SDKLimes\API\CRM\Store\Account\Account\TaxScheme;
 ...
 * @phpstan-import-type CollectionPlanShape from \SDKLimes\API\CRM\Store\Account\Account\CollectionPlan
 * @phpstan-import-type ContactShape from \SDKLimes\API\CRM\Store\Account\Account\Contact
 * @phpstan-import-type AccountCustomerShape from \SDKLimes\API\CRM\Update\AccountCustomer
 * @phpstan-import-type DetailShape from \SDKLimes\API\CRM\Store\Account\Account\Detail
 * @phpstan-import-type PhoneShape from \SDKLimes\API\CRM\Store\Account\Account\Phone
 * @phpstan-import-type TaxSchemeShape from \SDKLimes\API\CRM\Store\Account\Account\TaxScheme
 *

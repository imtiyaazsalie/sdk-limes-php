...
use SDKLimes\API\CRM\Store\Account\Account\Detail\BillMedia;
use SDKLimes\API\CRM\Store\Account\Account\Detail\Identification;
use SDKLimes\Core\Attributes\Optional;
use SDKLimes\Core\Concerns\SdkModel;
use SDKLimes\Core\Contracts\BaseModel;

/**
 * @phpstan-import-type BillMediaShape from \SDKLimes\API\CRM\Store\Account\Account\Detail\BillMedia
 * @phpstan-import-type IdentificationShape from \SDKLimes\API\CRM\Store\Account\Account\Detail\Identification
 *

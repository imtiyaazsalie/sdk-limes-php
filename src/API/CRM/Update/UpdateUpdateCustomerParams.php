...
/**
 * @see SDKLimes\Services\API\CRM\UpdateService::updateCustomer()
 *
 ...
 *
 * @phpstan-type UpdateUpdateCustomerParamsShape = array{
 *   address?: list<AccountAddress|AccountAddressShape>|null,
 *   detail?: null|Detail|DetailShape,
 *   isResidential?: bool|null,
 * }
 */
final class UpdateUpdateCustomerParams implements BaseModel
{
    /** @use SdkModel<UpdateUpdateCustomerParamsShape> */
    use SdkModel;
    use SdkParams;

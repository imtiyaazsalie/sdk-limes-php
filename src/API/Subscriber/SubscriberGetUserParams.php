...
/**
 * @see SDKLimes\Services\API\SubscriberService::getUser()
 *
 * @phpstan-type SubscriberGetUserParamsShape = array{
 *   limit?: int|null, page?: int|null
 * }
 */
final class SubscriberGetUserParams implements BaseModel
{
    /** @use SdkModel<SubscriberGetUserParamsShape> */
    use SdkModel;
    use SdkParams;
